...
IMAGE_TYPEDEP_rockchip-orangepi-gpt-img = "${IMG_ROOTFS_TYPE}"

GPTIMG = "${IMAGE_BASENAME}-${MACHINE}-gpt.img"
BOOT_IMG = "${IMAGE_BASENAME}-${MACHINE}-boot.img"
IDBLOADER = "idbloader.img"

# Get From orangepi-binary loader
DDR_BIN = "orangepi-binary/ddr.bin"
LOADER_BIN = "orangepi-binary/loader.bin"
MINILOADER_BIN = "orangepi-binary/miniloader.bin"
ATF_BIN = "orangepi-binary/atf.bin"
BL31_ELF = "orangepi-binary/bl31.elf"
TRUST_IMG = "trust.img"
...
do_image_rockchip_orangepi_gpt_img[depends] += " \
	orangepi-binary-loader:do_populate_lic \
...
do_image_rockchip_orangepi_gpt_img[depends] += " \
	...
	orangepi-binary-native:do_populate_sysroot \
	orangepi-binary-loader:do_deploy \
...
IMAGE_CMD_rockchip-orangepi-gpt-img () {
